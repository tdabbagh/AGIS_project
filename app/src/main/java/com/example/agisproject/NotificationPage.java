    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPostButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(NotificationPage.this, AddPostPage.class));
            }
        });
        ...
        profile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NotificationPage.this, Profile.class));
            }
        });
        ...
        mainPageBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NotificationPage.this, GlobalChatPage.class));
            }
        });
        ...
        directBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(NotificationPage.this, DirectMessagingDesign.class));
            }
        });
    }
}